...
int main(void){
    ...
    for(int t_count = 1; t_count < t+1; t_count++){
        ...
        int loop_counter=0;
        while(1){
            if(DEBUG) cout << "LOOP ITERATION : " << loop_counter << endl;
            ...
            while(1){
                ...
                if(fl) {
                    ...
                    do {
                        ...
                        num = num + (long long int)9*(long long int)pow(10, d_count-d_equals);
